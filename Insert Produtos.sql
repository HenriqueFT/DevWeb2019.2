...
,(4,'It: Capítulo Dois',11.00,'27 anos depois dos eventos de "It - A Coisa", Mike (Isaiah Mustafa) percebe que o palhaço Pennywise (Bill Skarsgard) está de volta A  cidade de Derry.
...
,(8,'Brilho Eterno de uma Mente sem Lembranças',120.00,'Joel (Jim Carrey) e Clementine (Kate Winslet) formavam um casal que, durante anos, tentaram fazer com que o relacionamento desse certo.
...
,(10,'Interestelar',24.99,'Após ver a Terra consumindo boa parte de suas reservas naturais, um grupo de astronautas recebe a missão de verificar possíveis planetas para receberem a população mundial, possibilitando a continuação da espécie.
...
,(15,'A Origem',88.00,'Em um mundo onde é possível entrar na mente humana, Cobb (Leonardo DiCaprio) está entre os melhores na arte de roubar segredos valiosos do inconsciente, durante o estado de sono.
...
Luke então se junta ao cavaleiro jedi e a Han Solo (Harrison Ford), um mercenário, para tentar destruir esta terrível ameaça ao lado dos membros da resistência.','17.jpg',69)
...
,(19,'O Quinto Elemento',45.00,'No século XXIII, um motorista de taxi (Bruce Willis) de Nova York se envolve em uma aventura na qual tem de deter um ser demoníaco que percorre a galáxia a cada 5000 anos.
Se nada for feito a Terra será destruída, mas para isto ele precisa encontrar 4 pedras antigas, que representam os elementos, e colocá-las em volta de uma bela mulher (Milla Jovovich), que é o quinto elemento.','19.jpg',23)
...
Porém, o que ambos não sabem é que o Pérola Negra, navio de Barbossa, foi atingido por uma terrível maldição que faz com que eles naveguem eternamente pelos oceanos e se transformem em esqueletos A  noite.','20.jpg',11)
...
Judy enfrenta o preconceito e as manipulaçAµes dos outros animais, mas conta com a ajuda inesperada da raposa Nick Wilde, conhecida por sua malícia e suas infraçAµes.
...
Após saber que sua casa está prestes a ser demolida, Arthur descobre que Ford Prefect (Mos Def), seu melhor amigo, é um extra-terrestre e, para completar, fica sabendo que a Terra está prestes a ser destruída para que se possa construir uma nova auto-estrada hiperespacial.
Sem ter o que fazer para evitar a destruição de seu planeta, Arthur só tem uma saída: pegar carona em uma nave espacial que está de passagem.
